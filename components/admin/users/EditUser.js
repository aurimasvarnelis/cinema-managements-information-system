        ...
        <Modal.Body> 
          <Form id="hook-form" onSubmit={handleSubmit(onSubmit)}>               
            <Form.Group className="mb-3" >
              ...
              <Form.Control required type="text" placeholder="Enter name" defaultValue={user.name} {...register("name")}/>
            </Form.Group>
            <Form.Group className="mb-3" >
              <Form.Label>Email</Form.Label>
              <Form.Control required type="text" placeholder="Enter email" defaultValue={user.email} {...register("email")}/>
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label htmlFor="role">Role</Form.Label>
              <Form.Select required defaultValue={user.role} {...register("role")}>   
                <option>user</option>
