				...
				<Modal.Body>
					<Form noValidate id="hook-form" validated={validated} onSubmit={handleSubmit(onSubmit)}>
						<Row>
							<Col>
								<Form.Group className="mb-3" controlId="validationPoster">
									...
									<Form.Control required accept=".png, .jpg" type="file" onChangeCapture={onUploadingPoster} {...register("poster")} />
						...
						<Form.Group className="mb-3">
							...
							<Form.Control as="textarea" rows="3" placeholder="Synopsis" {...register("synopsis")} />
						</Form.Group>
					</Form>
				</Modal.Body>
				<Modal.Footer>
